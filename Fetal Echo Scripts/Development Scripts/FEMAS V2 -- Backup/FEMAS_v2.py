...
# OPERATIONAL & TESTED
def masks_and_overlays(vertices, height, width, image, mask_path, overlay_path, jpg_name, counter):
    # AI Generated Code
        ...
        if os.path.exists(poten_path):
            ...
            for entry in annotation_json['annotations']:
                ...
                if (entry['imageId'] in dicom_set) and (mask_type == "box" or mask_type == "polygon"):
                    ...
                    all_masks_AND_overlays += masks_and_overlays(vertices_array, height, width, image, mask_path, overlay_path, jpg_exten, all_masks_AND_overlays)
